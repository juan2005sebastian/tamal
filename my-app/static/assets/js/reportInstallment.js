    ...
    if ($btnExportarPDF) {
        $btnExportarPDF.addEventListener("click", function () {
            try {
                ...
                doc.text("Reporte de Abonos" + (hayFiltrosActivos ? " Filtrado" : ""), 14, 15);
                ...
                const headers = [];
                document.querySelectorAll("#tbl_abonos thead th").forEach((th, index) => {
                    if (index < 6) { // Evitar la última columna (Acción)
                ...
                doc.save("Reporte_Abonos" + (hayFiltrosActivos ? "_Filtrado" : "") + ".pdf");
        ...
        $btnImprimir.addEventListener("click", function () {
            try {
                ...
                ventanaImpresion.document.write(`
                    <html>
                        <head>
                            <title>Imprimir Reporte de Abonos${hayFiltrosActivos ? " Filtrado" : ""}</title>
                            <style>
                                @media print {
                        ...
                        <body>
                            <h2>Reporte de Abonos${hayFiltrosActivos ? " Filtrado" : ""}</h2>
